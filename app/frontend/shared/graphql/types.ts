...
export type KnowledgeBaseCategoryDeleteMutation = { knowledgeBaseCategoryDelete: { __typename: 'KnowledgeBaseCategoryDeletePayload', success: boolean | null | undefined, errors: Array<{ __typename: 'UserError', message: string, messagePlaceholder: Array<string> | null | undefined, field: string | null | undefined, exception: Types.EnumUserErrorException | null | undefined }> | null | undefined } | null | undefined };

export type KnowledgeBaseCategoryUpdateMutationVariables = Exact<{
  categoryId: string | number;
  input: Types.KnowledgeBaseCategoryInput;
  locale: string;
}>;
...
export type KnowledgeBaseUpdateMutation = { knowledgeBaseUpdate: { __typename: 'KnowledgeBaseUpdatePayload', knowledgeBase: { __typename: 'KnowledgeBase', id: string, title: string | null | undefined, footerNote: string | null | undefined, policy: { __typename: 'PolicyKnowledgeBase', update: boolean } } | null | undefined, errors: Array<{ __typename: 'UserError', message: string, messagePlaceholder: Array<string> | null | undefined, field: string | null | undefined, exception: Types.EnumUserErrorException | null | undefined }> | null | undefined } | null | undefined };
...
export type AutocompleteSearchKnowledgeBaseCategoryIconQuery = { autocompleteSearchKnowledgeBaseCategoryIcon: Array<{ __typename: 'AutocompleteSearchKnowledgeBaseCategoryIconEntry', value: string, label: string, iconSet: 'anticon' | 'FontAwesome' | 'material' | 'ionicons' | 'Simple-Line-Icons' }> };
...
export type TicketStatisticsQuery = { ticketStatistics: { __typename: 'TicketStatistics', period: { __typename: 'TicketStatisticsPeriod', from: string, to: string, interval: string }, totals: { __typename: 'TicketStatisticsTotals', total: number, open: number, closed: number, escalated: number, averageFirstResponseMinutes: number | null | undefined, averageCloseMinutes: number | null | undefined, firstResponseInTimePercent: number | null | undefined, closeInTimePercent: number | null | undefined, timeLoggedMinutes: number | null | undefined, timeCoveragePercent: number | null | undefined }, comparison: { __typename: 'TicketStatisticsComparison', from: string, to: string, total: number, averageFirstResponseMinutes: number | null | undefined, averageCloseMinutes: number | null | undefined, firstResponseInTimePercent: number | null | undefined, closeInTimePercent: number | null | undefined, timeLoggedMinutes: number | null | undefined, timeCoveragePercent: number | null | undefined } | null | undefined, byGroup: Array<{ __typename: 'TicketStatisticsBucket', label: string, count: number }>, byOrganization: Array<{ __typename: 'TicketStatisticsBucket', label: string, count: number }>, byState: Array<{ __typename: 'TicketStatisticsBucket', label: string, count: number }>, byPriority: Array<{ __typename: 'TicketStatisticsBucket', label: string, count: number }>, byOwner: Array<{ __typename: 'TicketStatisticsBucket', label: string, count: number }>, byChannel: Array<{ __typename: 'TicketStatisticsBucket', label: string, count: number }>, byAxis: Array<{ __typename: 'TicketStatisticsAxis', name: string, label: string, buckets: Array<{ __typename: 'TicketStatisticsAxisBucket', value: string | null | undefined, label: string, count: number }> }>, volumeOverTime: Array<{ __typename: 'TicketStatisticsVolumePoint', date: string, created: number, closed: number, timeLoggedMinutes: number }> } };
...
export type TicketStatisticsAgentsQuery = { ticketStatisticsAgents: Array<{ __typename: 'TicketStatisticsAgent', id: string, label: string, open: number, escalated: number, dormant: number, received: number, closed: number, averageFirstResponseMinutes: number | null | undefined, averageCloseMinutes: number | null | undefined, closeInTimePercent: number | null | undefined, timeLoggedMinutes: number | null | undefined }> };
